...
export default function Header() {
  return (
    <header className="p-4 pl-15 bg-white flex justify-between items-center relative z-40 border-b border-gray-100">
      {/* Logo */}
      <img src="/logo.png" alt="Logo Fisioterapia" className="h-40 w-auto" />
      ...
      <nav className="flex items-center space-x-10 text-black text-xl font-semibold">
        ...
        {/* ─── MENÚ DESPLEGABLE TRATAMIENTOS (CSS PURA) ─── */}
        <div className="relative group py-4">
          ...
          <div className="absolute top-full left-0 hidden group-hover:flex flex-col w-64 bg-white shadow-xl border border-gray-100 rounded-xl p-2 text-base font-normal z-50">
            <a 
        ...
        <a href="/paquetes" className="hover:text-orange-500 transition-colors">
          Paquetes
        </a>
        ...
        {/* Sección Derecha: Acceso + Botón Cita */}
        <div className="flex items-center">
          <a href="/perfil" className="flex items-center gap-1 hover:opacity-80 pr-5">
            <UserCircle className="w-7 h-7 text-black" />
            <span>Acceso Pacientes</span>
          </a>

          {/* Línea vertical divisoria */}
          <div className="h-10 w-[3px] bg-orange-500 mx-2"></div>

          {/* Botón de Agenda */}
          <div className="m-5">
            <a 
              href="/perfil" 
              className="flex items-center gap-2 bg-orange-400 hover:bg-orange-500 p-4 rounded-lg text-white font-medium transition-colors"
            >
